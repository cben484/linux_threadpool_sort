...
//   struct dirent *ep;
//   vector<future<int>> results;
//   char file1[LINE_BUF_SIZE], file2[LINE_BUF_SIZE],
//   output_file[LINE_BUF_SIZE]; char buffer[LINE_BUF_SIZE]; int i = 1;
//   ThreadPool pool(THREAD_NUM);
...
//           //  Merge the first and second file marked before, add the thread
//           to
//           //  thread pool
...
int main(int argc, char *argv[]) {
  ...
  Solver s;
  int result_prefix = s.merge_orderd_files(0, TMP_FILE_DIR);
